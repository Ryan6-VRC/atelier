...
One line per paragraph, no hard wrap (`tools/reflow_md.py --check` is the meter — advisory at pre-commit, doesn't block). Skills follow `vrc-skills/CONVENTIONS.md`; pattern entries follow `vrc-patterns/CONVENTIONS.md`.
